...
describe("wasmcurves", () => {
  function getFieldElementF12(pR) {
    return [
      [
        [pb.get(pR), pb.get(pR + 32)],
        [pb.get(pR + 32 * 2), pb.get(pR + 32 * 3)],
        [pb.get(pR + 32 * 4), pb.get(pR + 32 * 5)]
      ],
      [
        [pb.get(pR + 32 * 6), pb.get(pR + 32 * 7)],
        [pb.get(pR + 32 * 8), pb.get(pR + 32 * 9)],
        [pb.get(pR + 32 * 10), pb.get(pR + 32 * 11)]
      ]
    ]
  }
