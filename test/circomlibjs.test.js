...
describe("circomlibjs", function () {
  describe("poseidon", function () {
    ...
    it("Should check constrain reference implementation poseidonperm_x5_254_3", async () => {
      ...
      assert(
        poseidonReference.F.eq(
          poseidonReference.F.e("0x115cc0f5e7d690413df64c6b9662e9cf2a3617f2743245519e19607a4417189a"),
          res1
        )
      )
      ...
      assert(
        poseidonOpt.F.eq(poseidonOpt.F.e("0x115cc0f5e7d690413df64c6b9662e9cf2a3617f2743245519e19607a4417189a"), res2)
      )

      const res3 = poseidonWasm([1, 2])
      assert(
        poseidonWasm.F.eq(poseidonWasm.F.e("0x115cc0f5e7d690413df64c6b9662e9cf2a3617f2743245519e19607a4417189a"), res3)
      )
    })
    it("Should check constrain reference implementation poseidonperm_x5_254_5", async () => {
      ...
      assert(
        poseidonReference.F.eq(
          poseidonReference.F.e("0x299c867db6c1fdd79dcefa40e4510b9837e60ebb1ce0663dbaa525df65250465"),
          res1
        )
      )
      ...
      assert(
        poseidonOpt.F.eq(poseidonOpt.F.e("0x299c867db6c1fdd79dcefa40e4510b9837e60ebb1ce0663dbaa525df65250465"), res2)
      )

      const res3 = poseidonWasm([1, 2, 3, 4])
      assert(
        poseidonWasm.F.eq(poseidonWasm.F.e("0x299c867db6c1fdd79dcefa40e4510b9837e60ebb1ce0663dbaa525df65250465"), res3)
      )
    })
