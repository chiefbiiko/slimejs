...
export default function buildBn128Wasm(module, _prefix) {
  ...
  const pG2b = module.alloc([
    ...bigInt2BytesLE(
      toMontgomery(19485874751759354771024239261021720505790618469301721065564631296452457478373n),
      f1size
    ),
    ...bigInt2BytesLE(
      toMontgomery(266929791119991161246907387137283842545076965332900288569378510910307636690n),
      f1size
    )
  ])
  ...
  function buildGTimesFr(fnName, opMul) {
    ...
    f.addCode(
      ...
      c.call(opMul, c.getLocal("pG"), AUX, c.i32_const(n8), c.getLocal("pr"))
    )
  ...
  function build_mulNR12() {
    ...
    f.addCode(
      ...
      c.call(f2mPrefix + "_copy", c.getLocal("x"), c.i32_add(c.getLocal("pr"), c.i32_const(n8 * 2))),
      c.call(
        f2mPrefix + "_copy",
  ...
  function buildMulByQ() {
    ...
    const MulByQX = c.i32_const(
      module.alloc([
        ...bigInt2BytesLE(
          toMontgomery("21575463638280843010398324269430826099269044274347216827212613867836435027261"),
          f1size
        ),
        ...bigInt2BytesLE(
          toMontgomery("10307601595873709700152284273816112264069230130616436755625194854815875713954"),
          f1size
        )
      ])
    )

    const MulByQY = c.i32_const(
      module.alloc([
        ...bigInt2BytesLE(
          toMontgomery("2821565182194536844548159561693502659359617185244120367078079554186484126554"),
          f1size
        ),
        ...bigInt2BytesLE(
          toMontgomery("3505843767911556378687030309984248845540243509899259641013678093033130930403"),
          f1size
        )
      ])
    )
  ...
  function buildPrepareG2() {
    ...
    f.addCode(
      ...
      c.block(
        c.loop(
          ...
          c.if(c.i32_load8_s(c.getLocal("i"), pAteLoopBitBytes), [
    ...
    if (isLoopNegative) {
      f.addCode(c.call(f2mPrefix + "_neg", RY, RY))
    }
  ...
  function buildMillerLoop() {
    ...
    if (isLoopNegative) {
      f.addCode(c.call(ftmPrefix + "_inverse", F, F))
    }
