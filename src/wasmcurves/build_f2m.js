...
export default function buildF2m(module, mulNonResidueFn, prefix, f1mPrefix) {
  ...
  function buildIsNegative() {
    ...
    f.addCode(
      c.if(c.call(f1mPrefix + "_isZero", x1), c.ret(c.call(f1mPrefix + "_isNegative", x0))),
  ...
  function buildIsSquare() {
    ...
    f.addCode(
      ...
      // if (F.eq(a0, F.negone)) return null;
      c.if(c.call(prefix + "_eq", a0, n1), c.ret(c.i32_const(0))),
      c.ret(c.i32_const(1))
    )
  }
  ...
  buildExp(module, prefix + "_exp", f1n8 * 2, prefix + "_mul", prefix + "_square", prefix + "_copy", prefix + "_one")
  buildSqrt()
  buildIsSquare()
