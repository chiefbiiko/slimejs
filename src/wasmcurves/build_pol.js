...
export default function buildPol(module, prefix, prefixField) {
  ...
  function buildZero() {
    ...
    f.addCode(
      ...
      c.setLocal("lastp", c.i32_add(c.getLocal("px"), c.i32_mul(c.getLocal("n"), c.i32_const(n8)))),
      c.block(
        c.loop(
          c.br_if(1, c.i32_eq(c.getLocal("p"), c.getLocal("lastp"))),
  ...
  function buildConstructLC() {
    ...
    f.addCode(
      ...
      c.block(
        c.loop(
          c.br_if(1, c.i32_eq(c.getLocal("i"), c.getLocal("nSignals"))),
          ...
          c.block(
            c.loop(
              c.br_if(1, c.i32_eq(c.getLocal("j"), c.getLocal("ncoefs"))),

              c.setLocal("pd", c.i32_add(c.getLocal("pres"), c.i32_mul(c.i32_load(c.getLocal("pp")), c.i32_const(n8)))),

              c.setLocal("pp", c.i32_add(c.getLocal("pp"), c.i32_const(4))),

              c.call(prefixField + "_mul", c.getLocal("ps"), c.getLocal("pp"), aux),

              c.call(prefixField + "_add", aux, c.getLocal("pd"), c.getLocal("pd")),
