...
export default function buildF3m(module, mulNonResidueFn, prefix, f1mPrefix) {
  ...
  function buildEq() {
    ...
    f.addCode(
      c.i32_and(
        c.i32_and(c.call(f1mPrefix + "_eq", x0, y0), c.call(f1mPrefix + "_eq", x1, y1)),
  ...
  function buildIsZero() {
    ...
    f.addCode(
      c.i32_and(
        c.i32_and(c.call(f1mPrefix + "_isZero", x0), c.call(f1mPrefix + "_isZero", x1)),
        c.call(f1mPrefix + "_isZero", x2)
      )
    )
  }
  ...
  function buildSign() {
    ...
    f.addCode(
      ...
      c.if(c.getLocal("s"), c.ret(c.getLocal("s"))),
  ...
  function buildIsOne() {
    ...
    f.addCode(
      c.ret(
        c.i32_and(
          c.i32_and(c.call(f1mPrefix + "_isOne", x0), c.call(f1mPrefix + "_isZero", x1)),
          c.call(f1mPrefix + "_isZero", x2)
        )
      )
    )
  ...
  buildExp(module, prefix + "_exp", f1n8 * 3, prefix + "_mul", prefix + "_square", prefix + "_copy", prefix + "_one")
